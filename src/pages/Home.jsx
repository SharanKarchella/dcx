...
function Home() {
  ...
  return (
    <main className="min-h-screen relative">
      ...
      {/* Contact Icon */}
      <span
        className="fixed bottom-6 right-6 w-12 h-12 md:w-20 md:h-20 bg-blue-500 text-white flex items-center justify-center rounded-full shadow-lg cursor-pointer z-50"
